const en = {
    ...
    loginBtn: 'Sign in',
    regBtn: 'Sign up',
    loginTitle: 'Sign in to your account to access email. Need access? Email admin@abyn.xyz to obtain an account or invite code.',
    regTitle: 'Sign up for an account to use email. Need access? Email admin@abyn.xyz to obtain an account or invite code.',
